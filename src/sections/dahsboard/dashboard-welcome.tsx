...
export function DashboardWelcome({ title, description, action, img, sx, ...other }: Props) {
  ...
  return (
    <Box
      sx={{
        ...bgGradient({
          color: `to bottom, ${varAlpha(theme.vars.palette.grey['900Channel'], 0.75)} 0%, ${theme.vars.palette.grey[900]} 75%`,
